...
for sample_id in sample_ids:
    ...
    try:
        ...
        if "TI_gene_filter" in xls.sheet_names:
            ...
            logging.warning(f"Neither 'TI_gene_filter' nor 'Fusion_Status' subsheets found in {fusion_output_file}. Skipping.")
            continue
...
for index, row in df.iterrows():
    ...
    bam_file_pattern = bs_path + f'/Projects/Somatic_Patient_RNA_July_25/AppResults/{sample_id}*/Files/{sample_id}.bam'
    prelim_file_pattern = bs_path + f'/Projects/Somatic_Patient_RNA_July_25/AppResults/{sample_id}*/Files/{sample_id}.fusion_candidates.preliminary'
            ...
            for _, row in match.iterrows():
                ...
                try:
                    ...
                    if read_names_list:
                        ...
                        intermediate_bam_path = os.path.join(fusion_folder, f'{sample_id}_{fusion}_{score}_filtered.bam')
    ...
    try:
        fasta_file = '/home/bioinfo4/Programs/Freebayes_Test_Runs/Common_files/hg19.fasta'
        ideogram_file = '/home/bioinfo4/Patient_Samples/GUI_Testing/Downstream_Standalone/igv/genomes/cytoBand.txt'
        gene_track = '/home/bioinfo4/Patient_Samples/GUI_Testing/Downstream_Standalone/igv/genomes/ncbiRefGene.txt'
        report_file = os.path.join(fusion_folder, f'{sample_id}_{fusion}_{score}_report.html')

        create_report_cmd = (
            f"create_report {bedpe_path} "
            f"--fasta {fasta_file} "
            f"--exclude-flag 512 "
