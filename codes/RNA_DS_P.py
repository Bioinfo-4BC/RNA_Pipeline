...
projID = sys.argv[1]  # Project ID passed as a command line argument
project_name = sys.argv[2] # Project name passed as a command line argument
bs_path = sys.argv[3]
...
def copy_scripts():
    script_sources = {
        "RNA_Filter_V2.py": homefolderpath + "/codes/RNA_Filter_V2.py",  # Replace with the actual path
        "RNA_Vis_V3.py": homefolderpath + "/codes/RNA_Vis_V3_P.py"                # Replace with the actual path
    }
...
def main():
    ...
    try:
        subprocess.run(["python3", "RNA_Vis_V3_P.py", bs_path, project_name], check=True)
